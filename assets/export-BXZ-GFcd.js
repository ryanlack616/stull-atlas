const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/plotly-custom-2d-Dssw1fWg.js","assets/find_empties-DRiZhjAu.js","assets/vendor-react-D0vdeqNS.js","assets/find_empties-CuCRB34y.css"])))=>i.map(i=>d[i]);
import{_ as R}from"./index-DFhyK2mv.js";import{g}from"./umf-Bef8OHIG.js";import"./vendor-react-D0vdeqNS.js";import"./vendor-state-DTYbmM1J.js";import"./vendor-router-DjLFn5nj.js";const O=["SiO2","Al2O3","B2O3","Na2O","K2O","CaO","MgO","ZnO","BaO","SrO","Li2O","Fe2O3","TiO2"];function j(t){const a=t.length>0&&t[0].meta?Object.keys(t[0].meta):[],n=["Label",...a,...O].join(","),o=t.map(i=>{const s=a.map(c=>{var r;return((r=i.meta)==null?void 0:r[c])??""}),e=O.map(c=>g(i.umf,c).toFixed(4));return[`"${i.label.replace(/"/g,'""')}"`,...s,...e].join(",")});return[n,...o].join(`
