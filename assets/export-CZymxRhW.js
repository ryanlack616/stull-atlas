...
import{_ as R}from"./index-CShX2zP3.js";import{g}from"./umf-Bjrc84p_.js";import"./vendor-react-D380Hx73.js";import"./vendor-state-CUnBHQ16.js";import"./vendor-router-1trnvaIQ.js";const O=["SiO2","Al2O3","B2O3","Na2O","K2O","CaO","MgO","ZnO","BaO","SrO","Li2O","Fe2O3","TiO2"];function j(t){const a=t.length>0&&t[0].meta?Object.keys(t[0].meta):[],n=["Label",...a,...O].join(","),o=t.map(i=>{const s=a.map(c=>{var r;return((r=i.meta)==null?void 0:r[c])??""}),e=O.map(c=>g(i.umf,c).toFixed(4));return[`"${i.label.replace(/"/g,'""')}"`,...s,...e].join(",")});return[n,...o].join(`
