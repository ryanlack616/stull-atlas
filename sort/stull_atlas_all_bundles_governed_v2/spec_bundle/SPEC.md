...
- State + sync contracts (user-visible behavior)
- Validation & limits policy
- Compatibility selection behavior
...
- Example layouts
- Optional UI “skins” ideas
- Any section explicitly labeled Example
...
## Project bundles
- See `PROJECT_BUNDLE_SCHEMA_v0.md` for the portable bundle layout and migration rules.

## Stull guides
- v1 starter guides: `stull_guides.v1.json` (refine via domain review).

## Golden tests
- Template + expected outputs: `GOLDEN_TESTS.md` and `golden_tests.*.json`.

## Compatibility profiles
- Contract: `COMPATIBILITY_CONTRACT.md`
- Profiles: `COMPATIBILITY_PROFILES.md`, `molar_masses.*.json`
