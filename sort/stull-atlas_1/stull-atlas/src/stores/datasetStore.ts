...
const DEFAULT_DATASETS: DatasetInfo[] = [
  {
    id: 'digitalfire_2024',
    name: 'Digitalfire 2024',
    description: 'Current Digitalfire oxide analyses',
    materialCount: 0
  },
  {
    id: 'glazy_default',
  ...
  },
  {
    id: 'insight_legacy',
    name: 'Insight (Legacy)',
    description: 'Historical Insight software data',
    materialCount: 0
  }
]
...
export const useDatasetStore = create<DatasetState & DatasetActions>((set, get) => ({
  ...
  currentDataset: 'digitalfire_2024',
  
  wiggleTest: {
    isAnimating: false,
    animationSpeed: 500,
    currentIndex: 0,
    datasetsToCompare: ['digitalfire_2024', 'glazy_default', 'insight_legacy']
  },
