 ...
 */
export const OXIDE_CLASSES = {
  R2O:  ['Li2O', 'Na2O', 'K2O'] as OxideSymbol[],
  RO:   ['MgO', 'CaO', 'SrO', 'BaO', 'ZnO', 'PbO'] as OxideSymbol[],
  R2O3: ['Al2O3', 'B2O3', 'Fe2O3'] as OxideSymbol[],
  RO2:  ['SiO2', 'TiO2', 'ZrO2', 'SnO2'] as OxideSymbol[],
}

export const FLUX_OXIDES: OxideSymbol[] = [...OXIDE_CLASSES.R2O, ...OXIDE_CLASSES.RO]
