...
export const EVENTS: TimelineEvent[] = [
  ...
  },
  {
    ...
    description: 'Parmalee\u2019s comprehensive treatment of glaze chemistry includes detailed discussion of the Stull chart and its practical applications. Industrial knowledge made accessible to studio potters.',
    category: 'publication',
  ...
  },
  {
    ...
    description: 'Encyclopedic reference covering every aspect of ceramic materials and processes (UK). Becomes the definitive materials dictionary for studio potters.',
    category: 'publication',
  ...
  {
    year: 1988,
    title: 'Nigel Wood — \u201COriental Glazes\u201D',
    description: 'Scholarly analysis of historical Chinese and Japanese glaze chemistry (UK). Scientific approach to understanding how ancient potters achieved their results without molecular knowledge.',
    category: 'publication',
    people: ['Nigel Wood'],
    significance: 3,
  },
  ...
  },
  {
    ...
    description: 'Ian Currie (d. 2011) introduced the Grid Method for systematic glaze testing. His approach allows potters to efficiently explore the SiO₂–Al₂O₃ landscape with real test tiles, bridging theory and practice. Testing moves from random trials to mathematical coverage of possibility space.',
    category: 'publication',
    people: ['Ian Currie'],
    significance: 1,
    inflectionPoint: true,
  ...
  },
  {
    ...
    description: 'Comprehensive colorant guide documenting the full spectrum of ceramic colorants and their interactions (Canada). Definitive colorant reference for studio potters.',
    category: 'publication',
    people: ['Robin Hopper'],
    significance: 2,
  },
